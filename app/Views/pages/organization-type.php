                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors duration-150">
                                ...
                                <td class="px-5 py-4 text-left pr-6">
                                    <div class="flex justify-left gap-2">
                                        ...
                                        <button class="w-8 h-8 rounded-lg bg-red-50 text-red-600 hover:bg-red-100 border border-red-100 transition delete-type-btn flex items-center justify-center" data-id="<?= $type['id'] ?>" data-name="<?= esc($type['name']) ?>" title="Delete">
    ...
    function renderOrgTypesTable(orgTypes) {
        ...
        if(!orgTypes || orgTypes.length === 0) {
            ...
            orgTypes.forEach(function(type, index) {
                let typeName = type.name ? type.name : '';
                let row = '<tr class="hover:bg-slate-50/80 transition-colors duration-150">' +
                    ...
                    '<td class="px-5 py-4 font-bold text-slate-800">' + typeName + '</td>' +
                    ...
                    '<td class="px-5 py-4 text-left pr-6">' +
                        '<div class="flex justify-left gap-2">' +
                            ...
                            '<button class="w-8 h-8 rounded-lg bg-red-50 text-red-600 hover:bg-red-100 border border-red-100 transition delete-type-btn flex items-center justify-center" data-id="' + type.id + '" data-name="' + typeName + '" title="Delete"><i class="fas fa-trash-can text-xs"></i></button>' +
                        '</div>' +
                    '</td>' +
                    '</tr>';
                tbody.append(row);
