                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors duration-150">
                                ...
                                <td class="px-5 py-4 text-left pr-6">
                                    <div class="flex justify-left gap-2">
                                        ...
                                        <button class="w-8 h-8 rounded-lg bg-red-50 text-red-600 hover:bg-red-100 border border-red-100 transition delete-btn flex items-center justify-center" data-id="<?= $org['id'] ?>" data-name="<?= esc($org['org_name']) ?>" title="Delete">
    ...
    function renderOrganizationsTable(organizations) {
        ...
        if(!organizations || organizations.length === 0) {
            ...
            organizations.forEach(function(org, index) {
                ...
                let orgName = org.org_name ? org.org_name : '';
                ...
                let row = '<tr class="hover:bg-slate-50/80 transition-colors duration-150">' +
                    ...
                    '<td class="px-5 py-4">' +
                        '<div class="font-bold text-slate-800">' + orgName + '</div>' +
                    ...
                    '<td class="px-5 py-4 text-left pr-6">' +
                        '<div class="flex justify-left gap-2">' +
                            ...
                            '<button class="w-8 h-8 rounded-lg bg-red-50 text-red-600 hover:bg-red-100 border border-red-100 transition delete-btn flex items-center justify-center" data-id="' + org.id + '" data-name="' + orgName + '" title="Delete"><i class="fas fa-trash-can text-xs"></i></button>' +
                        '</div>' +
                    '</td>' +
                    '</tr>';
                tbody.append(row);
