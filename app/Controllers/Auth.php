...
class Auth extends BaseController
{
    ...
    public function register()
    {
        try {
            ...
            create_audit_action(null, $email, 'REGISTRATION', 'PENDING', $registrationNo, 'Registration successful. Please upload your Authorization Letter.');
    ...
    public function uploadAuthorization()
    {
        try {
            ...
            $captcha = trim(
                (string) $this->request->getPost('captcha')
            );
            if ($captcha === '') {
            ...
            $uploadPath =
                WRITEPATH . 'uploads/authorization/';
            ...
            $oldFileName =
                $registration['authorization_letter']
                ?? null;
            ...
            try {
                ...
                if (!$updated) {
                    ...
                    throw new \RuntimeException(
                        'Unable to update registration record.'
                    );
                }
                $historyInserted =
                    $db->table('registration_history')
                        ->insert([
                            'reg_id' =>
                                $regId,
                ...
                if (!$historyInserted) {
                    ...
                    throw new \RuntimeException(
                        'Unable to create registration history.'
                    );
                }
                if (
                ...
                return $this->response->setJSON([
                    ...
                    'message' =>
                        'Authorization Letter submitted successfully. Your application is pending approval.',
                ...
                log_message(
                    'error',
                    'Authorization Upload Transaction Error: ' .
                    $e->getMessage()
                );
                return $this->response->setJSON([
                    'success'  => false,
