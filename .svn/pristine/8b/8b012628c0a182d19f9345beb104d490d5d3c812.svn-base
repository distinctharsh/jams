                        ...
                        <?php foreach($settings as $index => $setting): ?>
                            <tr class="hover:bg-slate-50/80 transition-colors duration-150">
                                ...
                                <td class="px-5 py-4 text-slate-600 font-medium text-left">
                                    <?= !empty($setting['value']) ? esc($setting['value']) : '<span class="text-slate-400 italic">N/A</span>' ?>
                                </td>
        ...
        if (!settings || settings.length === 0) {
            ...
            settings.forEach(function(setting, index) {
                ...
                let row = '<tr class="hover:bg-slate-50/80 transition-colors duration-150">' +
                    ...
                    '<td class="px-5 py-4 text-slate-600 font-medium text-left">' + (setting.value ? setting.value : '<span class="text-slate-400 italic">N/A</span>') + '</td>' +
                    '<td class="px-5 py-4 text-left">' +
                        (isActive ? 
