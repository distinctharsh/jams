                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors duration-150">
                                ...
                                <td class="px-5 py-4 text-left pr-6">
                                    <div class="flex justify-left gap-2">
                                        ...
                                        <button class="w-8 h-8 rounded-lg bg-red-50 text-red-600 hover:bg-red-100 border border-red-100 transition delete-vendor-btn flex items-center justify-center" data-id="<?= $vendor['id'] ?>" data-name="<?= esc($vendor['vendor_name']) ?>" title="Delete">
    ...
    function renderVendorsTable(vendors) {
        ...
        if(!vendors || vendors.length === 0) {
            ...
            vendors.forEach(function(vendor, index) {
                ...
                let vendorName = vendor.vendor_name ? vendor.vendor_name : '';
                let row = '<tr class="hover:bg-slate-50/80 transition-colors duration-150">' +
                    ...
                    '<td class="px-5 py-4 font-bold text-slate-800">' + vendorName + '</td>' +
                    '<td class="px-5 py-4 text-left">' +
                        (isActive ? 
                    ...
                    '<td class="px-5 py-4 text-left pr-6">' +
                        '<div class="flex justify-left gap-2">' +
                            ...
                            '<button class="w-8 h-8 rounded-lg bg-red-50 text-red-600 hover:bg-red-100 border border-red-100 transition delete-vendor-btn flex items-center justify-center" data-id="' + vendor.id + '" data-name="' + vendorName + '" title="Delete"><i class="fas fa-trash-can text-xs"></i></button>' +
                        '</div>' +
                    '</td>' +
                    '</tr>';
                tbody.append(row);
