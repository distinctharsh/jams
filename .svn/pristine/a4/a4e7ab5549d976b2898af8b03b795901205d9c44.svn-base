...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900&family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900&family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900&display=swap" rel="stylesheet">
  <!-- Vendor CSS -->
...
<header id="header" class="header fixed-top">
  <!-- Top Bar -->
<!-- ================= Top Government Bar ================= -->
<div class="topbar gov-topbar py-2">
                ...
                <div class="d-flex justify-content-end align-items-center flex-wrap gap-3">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow">
                            <li>
                                <button class="dropdown-item" onclick="changeFont(1)">
                                    A+
                                </button>
                            </li>
                            <li>
                                <button class="dropdown-item" onclick="changeFont(0)">
                                    A
                                </button>
                            </li>
                            <li>
                            ...
                            <li>
                                <button class="dropdown-item" onclick="toggleContrast()">
                                    High Contrast
                                </button>
                            </li>
                            <li>
                                <button class="dropdown-item" onclick="resetAccessibility()">
                                    Reset
                                </button>
                            </li>
                        </ul>
  ...
  <div class="branding d-flex align-items-center">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="<?= base_url() ?>" class="logo d-flex align-items-center text-decoration-none">
        ...
        <div class="ms-3">
        <h5 class="mb-0 fw-bold hindi-title">
            मंत्रिमंडल सचिवालय
        </h5>
        <h4 class="mb-0 fw-bold cabinet-title">
            Cabinet Secretariat
        </h4>
        <small class="gov-title">
            Government of India
        </small>
        </div>
      </a>
    ...
    <div class="d-none d-lg-flex align-items-center ms-4 gap-3">
    <!-- Digital India -->
    <a href="https://www.digitalindia.gov.in/"
       target="_blank"
       title="Digital India">
        <img src="https://master-cabsec.digifootprint.gov.in/static/uploads/2025/06/89b0a44d4c258057766cac713a24c09f.png"
             alt="Digital India"
             class="gov-logo">
    </a>
    <!-- Swachh Bharat -->
    ...
    <img src="<?= base_url('assets/image/swach-bharat.png') ?>"
    alt="Swachh Bharat"
    class="gov-logo">
    </a>
   </div>
